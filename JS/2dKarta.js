...
const salar = {
  ...
  Matsal: { x: 0.6, y: 0.88, level: 3 },
  Blackbox: { x: 0.47, y: 0.57, level: 3 },
  Livskunskapen: { x: 0.35, y: 0.595, level: 3 },
  3287: { x: 0.953, y: 0.58, level: 3 },
  3403: { x: 0.55, y: 0.05, level: 3 },
  "3454B": { x: 0.45, y: 0.78, level: 3 },
  3464: { x: 0.45, y: 0.425, level: 3 },
  "Tore Wretman": { x: 0.45, y: 0.425, level: 3 },
  3465: { x: 0.45, y: 0.465, level: 3 },
  "Kajsa Warg": { x: 0.45, y: 0.465, level: 3 },
  ...
  3710: { x: 0.44, y: 0.7, level: 3 },
  3712: { x: 0.37, y: 0.67, level: 3 },
  3713: { x: 0.3, y: 0.67, level: 3 },
  3714: { x: 0.3, y: 0.635, level: 3 },
  3715: { x: 0.37, y: 0.63, level: 3 },
  3716: { x: 0.41, y: 0.63, level: 3 },
  3717: { x: 0.46, y: 0.63, level: 3 },
